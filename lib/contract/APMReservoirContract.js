...
class APMReservoirContract extends EthereumContract_1.default {
    constructor() {
        super(Config_1.default.contracts.APMReservoir, APMReservoir_json_1.default.abi, [
            "AddSigner",
            "RemoveSigner",
            "SendToken",
            "ReceiveToken",
    ...
    addTokenToWallet() {
        EthereumWallet_1.default.addToken(APMCoinContract_1.default.address, "APM", 18, "https://bridge.apm-coin.com/images/shared/icn/icn-apmcoin-256.png");
    }
