...
export interface IAPMReservoir extends BaseContract {
    ...
    functions: {
        ...
        isValidChain(toChainId: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        isValidChain(toChainId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        quorum(overrides?: CallOverrides): Promise<BigNumber>;
        receiveToken(sender: string, fromChainId: BigNumberish, receiver: string, amount: BigNumberish, sendingId: BigNumberish, isFeePayed: boolean, protocolFee: BigNumberish, senderDiscountRate: BigNumberish, data: BytesLike, vs: BigNumberish[], rs: BytesLike[], ss: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isValidChain(toChainId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
