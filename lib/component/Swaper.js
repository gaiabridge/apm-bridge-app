...
const EthFeeDBContract_1 = __importDefault(require("../contract/EthFeeDBContract"));
...
const KlaytnFeeDBContract_1 = __importDefault(require("../contract/KlaytnFeeDBContract"));
            ...
            if (receiver === _receiver) {
                try {
                    ...
                    const senderDiscountRate = this.fromForm.chainId === 8217 ?
                        await KlaytnFeeDBContract_1.default.userDiscountRate(sender) :
                        await EthFeeDBContract_1.default.userDiscountRate(sender);
                    ...
                    await this.toForm.sender.receiveToken(sender, this.fromForm.chainId, receiver, amount, sendingId, isFeePayed, protocolFee, senderDiscountRate.toNumber(), ethers_1.utils.defaultAbiCoder.encode(["address"], [ethers_1.constants.AddressZero]), vs, rs, ss);
                }
                catch (error) {
