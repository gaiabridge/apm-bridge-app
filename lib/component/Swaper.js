...
class Swaper extends skynode_1.DomNode {
    constructor() {
        ...
        this.append((0, skynode_1.el)("section.swap-container", (0, skynode_1.el)(".form-container", (this.fromForm = new Form_1.default(this, 8217, true)), (0, skynode_1.el)("a", {
            click: () => {
            }
            ...
            click: async () => {
                ...
                this.amountInput.domElement.value = ethers_1.utils.formatEther(balance);
            }
            ...
            "disabled": "",
            click: async () => {
                await APMCoinContract_1.default.approve("0x7408C2E100FaC5302be554D860899216aCd76951", ethers_1.constants.MaxUint256);
            }
        }), (0, skynode_1.el)("button", "Transfer\n전송하기", {
            click: () => this.send(ethers_1.utils.parseEther(this.amountInput.domElement.value)),
        })))), (0, skynode_1.el)("section.history-container", (0, skynode_1.el)(".title", "전송 이력"), (0, skynode_1.el)("p", "트랜잭션이 한번 시작되면 되돌릴 수 없습니다.\nTransfer후 Claim 까지 완료되어야 체인 간 전송이 완료됩니다"), this.sendedList = (0, skynode_1.el)("table", (0, skynode_1.el)("thead", (0, skynode_1.el)("tr", (0, skynode_1.el)("td", "From Chain"), (0, skynode_1.el)("td", "To Chain"), (0, skynode_1.el)("td", "Amount"), (0, skynode_1.el)("td", "Fee"), (0, skynode_1.el)("td", "Time"), (0, skynode_1.el)("td", "Status"))))));
        this.getApprove(1);
    ...
    async getApprove(amount) {
        ...
        if ((await APMCoinContract_1.default.allowance(owner, "0x7408C2E100FaC5302be554D860899216aCd76951")).lt(amount)) {
