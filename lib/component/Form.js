...
class Form extends skynode_1.DomNode {
    constructor(swaper, chainId, isFrom = false) {
        ...
        }), (this.balanceDisplay = (0, skynode_1.el)("p")), (0, skynode_1.el)(".address-container", (this.addressDisplay = (0, skynode_1.el)("p")), (this.disconnectButton = (0, skynode_1.el)("a.disconnect", (0, skynode_1.el)("img", { src: "/images/shared/icn/icn-disconnect.svg" })))), (this.buttonContainer = (0, skynode_1.el)(".button-container")));
