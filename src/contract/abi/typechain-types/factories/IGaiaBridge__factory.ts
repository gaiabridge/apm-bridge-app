...
export class IGaiaBridge__factory {
  static readonly abi = _abi;
  static createInterface(): IGaiaBridgeInterface {
    return new utils.Interface(_abi) as IGaiaBridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IGaiaBridge {
    return new Contract(address, _abi, signerOrProvider) as IGaiaBridge;
  }
}
